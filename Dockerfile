# DO THIS FIRST: 
# curl http://cdimage.ubuntu.com/ubuntu-core/releases/wily/release/ubuntu-core-15.10-core-armhf.tar.gz | gunzip | sudo docker import - iotms/rpi2-ubuntu-core:15.10

FROM iotms/rpi2-ubuntu-core:15.10
